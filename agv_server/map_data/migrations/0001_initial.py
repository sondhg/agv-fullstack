    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["node1"], name="map_data_co_node1_4dc7a3_idx"),
                    models.Index(fields=["node2"], name="map_data_co_node2_749ff4_idx"),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["node1"], name="map_data_di_node1_bf8d80_idx"),
                    models.Index(fields=["node2"], name="map_data_di_node2_3b3986_idx"),
                ],
                "unique_together": {("node1", "node2")},
            },
        ),
