...
def get_action(previous_node, current_node, reserved_node):
    ...
    if direction_from_previous_node_to_current_node is None or direction_from_current_node_to_reserved_node is None:
        return GO_STRAIGHT  # Default to GO_STRAIGHT if direction data is missing

    if direction_from_previous_node_to_current_node == direction_from_current_node_to_reserved_node:
    ...
    return direction_actions.get(direction_from_previous_node_to_current_node, {}).get(direction_from_current_node_to_reserved_node, GO_STRAIGHT)
