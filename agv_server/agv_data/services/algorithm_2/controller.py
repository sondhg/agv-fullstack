    ...
    def update_agv_state(self, agv_id: int) -> Dict:
        ...
        try:
            ...
            if agv.current_node == order.workstation_node:
                ...
                if (agv.spare_flag and agv.next_node and not is_node_reserved_by_others(agv.next_node, agv.agv_id)):
