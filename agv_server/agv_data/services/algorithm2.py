...
This algorithm handles decision making for AGV movements, determining whether an AGV should move, stop, or wait.
...
3. When AGV is in sequential shared points with spare points (F^i = 1), it should remove the spare point for its current position when it reaches a new point
"""
